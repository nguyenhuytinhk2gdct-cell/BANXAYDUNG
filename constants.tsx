...
import { BookOpen, Quote, MessageSquare, FileCheck } from 'lucide-react';
...
2. CHỈ DÙNG văn bản thay thế mới nhất:
   ...
   - Chỉ thị 35-CT/TW: Đại hội đảng bộ các cấp tiến tới Đại hội XIV của Đảng.
...
export const SECTION_ICONS: Record<string, React.ReactNode> = {
  ...
  'DOCS': <FileCheck className="w-5 h-5" />
};
